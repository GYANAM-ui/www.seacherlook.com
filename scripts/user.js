...
function videoChat() {
    ...
    u_room = document.getElementById("u_room").value;

    sessionStorage.setItem("user_name", u_name);
    sessionStorage.setItem("user_room", u_room);
...
function joinChat() {
    ...
    sessionStorage.setItem("room", room_code);
    window.location = "joinChat.html";
}